...
import com.oneforma.common.annotation.ApiVersion;
import com.oneforma.common.base.ResponseResult;
import com.oneforma.common.constants.CustomVersion;
import com.oneforma.common.utils.OkHttpClientUtil;
...
//    @ApiVersion(CustomVersion.VERSION_1)
    @Operation(summary = "import dict data")
    @PostMapping("/test")
